...
(or network architectures) to use for specific tasks. It is expensive to gather training data for these models as
each data sample requires training a model. Active learning (or other clever techniques) could select the most interesting experiments to run. "
